...
public class LoadBalancerInstance 
{
	 ...
	 */
	public LoadBalancerInstance(int virtualIP, byte[] virtualMAC, List<Integer> hostIPs)
	{
	 ...
	 * @param hostIPs IPs for hosts to which requests should be balanced 
	 */
	public LoadBalancerInstance(String virtualIP, String virtualMAC, String[] hostIPs)
	{
